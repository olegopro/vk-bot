...
namespace App\Facades {
     ...
     */        class VkClient {
         ...
         * @throws VkException
         * @static 
         */        public static function request($method, $parameters = [], $token = null)
        {
                        /** @var \App\Services\VkClientService $instance */
        ...
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchAllAccounts();
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchAccountData($ids)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchAccountData($ids);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchGroupData($id)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchGroupData($id);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchAccountFollowers($id, $limit)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchAccountFollowers($id, $limit);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchAccountFriends($id, $limit = 6)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchAccountFriends($id, $limit);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchAccountCountFriends($accountId, $ownerId, $token)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchAccountCountFriends($accountId, $ownerId, $token);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchAccountInfo($token)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchAccountInfo($token);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchAccountNewsfeed($accountId, $startFrom, $loggingService)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchAccountNewsfeed($accountId, $startFrom, $loggingService);
        }
                    /**
         * 
         *
         * @static 
         */        public static function fetchWallPostsByDomain($accountId, $domain, $startFrom, $loggingService)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchWallPostsByDomain($accountId, $domain, $startFrom, $loggingService);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchLikes($access_token, $type, $owner_id, $item_id)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchLikes($access_token, $type, $owner_id, $item_id);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function fetchUsers($users_ids)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->fetchUsers($users_ids);
        }
                    /**
         ...
         *
         * @param \App\Filters\VkUserSearchFilter $filter Фильтр с параметрами поиска
         * @param int $accountId ID аккаунта, от имени которого выполняется поиск
         * @return array Результаты поиска пользователей
         * @throws VkException
         * @static 
         */        public static function searchUsers($filter, $accountId)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->searchUsers($filter, $accountId);
        }
                    /**
         ...
         * @static 
         */        public static function getCities($query, $countryId = 1, $count = 100)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->getCities($query, $countryId, $count);
        }
                    /**
         ...
         * @static 
         */        public static function getAccessTokenByAccountID($account_id)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->getAccessTokenByAccountID($account_id);
        }
                    /**
         ...
         * @static 
         */        public static function getScreenNameByToken($access_token)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->getScreenNameByToken($access_token);
        }
                    /**
         * Устанавливает данные аккаунта.
         *
         * @param string $token Токен доступа.
         * @param \App\Repositories\AccountRepositoryInterface $accountRepository Репозиторий аккаунтов.
         * @return array 
         * @throws VkException
         * @static 
         */        public static function setAccountData($token, $accountRepository)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->setAccountData($token, $accountRepository);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function addLike($ownerId, $itemId, $accessToken, $loggingService)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->addLike($ownerId, $itemId, $accessToken, $loggingService);
        }
                    /**
        ...
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->deleteAccount($id);
        }
                    /**
         ...
         * @throws VkException
         * @static 
         */        public static function deleteLike($accessToken, $type, $owner_id, $item_id)
        {
                        /** @var \App\Services\VkClientService $instance */
                        return $instance->deleteLike($accessToken, $type, $owner_id, $item_id);
        }
            }
    }
...
namespace  {
            ...
            class VkClient extends \App\Facades\VkClient {}
